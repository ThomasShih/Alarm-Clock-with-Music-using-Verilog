...
#
# Generated by Vivado on Thu Dec 06 20:39:46 -0500 2018
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../alarm_clock_competition.srcs/sources_1/ip/clk_wiz_0_1" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../alarm_clock_competition.srcs/sources_1/ip/clk_wiz_0_1" \
    "$ref_dir/../../../../alarm_clock_competition.srcs/sources_1/ip/clk_wiz_0_1/clk_wiz_0_sim_netlist.v" \
  2>&1 | tee -a vlogan.log
