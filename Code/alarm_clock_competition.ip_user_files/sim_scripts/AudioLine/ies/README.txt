...
#
# Generated by export_simulation on Thu Dec 06 15:53:59 -0500 2018
#
################################################################################
...
'-reset_run' switch to the './AudioLine.sh' script.

./AudioLine.sh -reset_run
...
./AudioLine.sh -noclean_files

For more information on the script, please type './AudioLine.sh -help'.
