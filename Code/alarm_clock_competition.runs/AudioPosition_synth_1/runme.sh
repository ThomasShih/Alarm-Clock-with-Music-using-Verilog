...
HD_PWD='C:/Users/thomasshih/Desktop/alarm_clock_competition/alarm_clock_competition.runs/AudioPosition_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AudioPosition.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AudioPosition.tcl
