...
#
# Generated by export_simulation on Sat Dec 01 14:17:38 -0500 2018
#
################################################################################
...
switch to the './month_counter.sh' script.

./month_counter.sh -reset_run
...
./month_counter.sh -noclean_files

For more information on the script, please type './month_counter.sh -help'.
